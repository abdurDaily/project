...
@section('report-table')
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <br><br>
                            ...
                            <label for="category">Details About Post</label>
                            <textarea class="mt-2" id="editor" name="editor" id="editor" cols="30" rows="10"></textarea>
                            @error('editor')
                                <strong class="text-danger">{{ $message }}</strong>
                            @enderror
    ...
    @push('niceSelect2CSS')
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/ckeditor/4.22.1/contents.min.css" integrity="sha512-HK3G0WJTxeYhsh/hzS/1NDmqw1uZplDy2w2Z60xHPTytEKEpSSXF9DsXytkUNLh7AyPeBvyVSpz4+kRCxTDYqQ==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    @endpush
